...
```bash
docker run --rm -e MYSQL_ROOT_PASSWORD=1234 -e MYSQL_USER=ubuntu -e MYSQL_PASSWORD=1234 -p 3306:3306 mysql
```
...
```bash
docker run --rm -e MYSQL_HOST=$(hostname -i) -e MYSQL_USER=ubuntu -e MYSQL_PASSWORD=1234 -p 5000:5000 app
```
